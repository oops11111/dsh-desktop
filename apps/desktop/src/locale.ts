...
export const en = {
  ...
  startupFailed: 'Candy is unavailable',
  ...
  updateDownloadedTitle: 'Candy v{version} downloaded',
...
export const zh = {
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'Candy v{version} 下载完成',
